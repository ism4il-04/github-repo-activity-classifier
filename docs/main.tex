...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{llL}
    ...
    \texttt{GITHUB\_TOKEN} & \textit{Aucune} & Token pour contourner les limites de l'API GitHub \\
    \texttt{USE\_MOCK\_API} & \texttt{false} & Activer pour simuler l'API Backend \\
    \texttt{PORT} & \texttt{8500} & Port de l'interface Streamlit \\
    \bottomrule
  \end{tabularx}
\end{table}
